...
const UpdateSecurityStaff = ({
  ...
  const fetchSecurityStaffDetails = async (id) => {
    try {
      const response = await axios.get(
        `https://prison-management-system-backend.onrender.com/api/securityStaff/${id}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://prison-management-system-backend.onrender.com/api/securityStaff/update/${securityStaffId}`,
        securityStaffData
      );
              ...
              <div className="w-1/2">
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="firstName"
                      value={securityStaffData.firstName}
                      onChange={handleChange}
                      className={`${
                        errors.firstName ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.firstName && (
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="lastName"
                      value={securityStaffData.lastName}
                      onChange={handleChange}
                      className={` ${
                        errors.lastName ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.lastName && (
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="date"
                      name="dateOfBirth"
                      value={securityStaffData.dateOfBirth}
                      onChange={handleChange}
                      className={` ${
                        errors.dateOfBirth ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.dateOfBirth && (
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <select
                      name="gender"
                      value={securityStaffData.gender}
                      onChange={handleChange}
                      className={` ${
                        errors.gender ? "form-error-border" : "form-border"
                      }  form-input`}
                    >
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="nic"
                      value={securityStaffData.nic}
                      onChange={handleChange}
                      className={` ${
                        errors.nic ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.nic && (
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="phone"
                      value={securityStaffData.phone}
                      onChange={handleChange}
                      className={` ${
                        errors.phone ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.phone && (
              ...
              <div className="w-1/2">
                <div className="form-input-div">
                  ...
                  <div>
                    <select
                      name="maritalStatus"
                      value={securityStaffData.maritalStatus}
                      onChange={handleChange}
                      className={` ${
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="religion"
                      value={securityStaffData.religion}
                      onChange={handleChange}
                      className={` ${
                        errors.religion ? "form-error-border" : "form-border"
                      }  form-input`}
                    />
                    {errors.religion && (
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      ...
                      value={securityStaffData.educationalBackground}
                      onChange={handleChange}
                      className={` ${
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="certification"
                      value={securityStaffData.certification}
                      onChange={handleChange}
                      className={` ${
