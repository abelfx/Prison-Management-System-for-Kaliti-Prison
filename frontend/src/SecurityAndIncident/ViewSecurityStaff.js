  ...
  const getStaffDetails = async (staffId) => {
    try {
      const response = await axios.get(
        `https://prison-management-system-backend.onrender.com/api/securityStaff/${staffId}`
      );
        ...
        {staffDetails ? (
          <div className="staff-details" ref={componentRef}>
            ...
            >
              ...
              <h1 style={{ fontFamily: "cursive", marginBottom: "2px" }}>
            ...
            <div>
              <div className="personal-info">
                ...
                >
                  <p>
                    <strong>First Name:</strong> {staffDetails.firstName}
                  </p>
                  <p>
                    <strong>Last Name:</strong> {staffDetails.lastName}
                  </p>
                  <p>
                    <strong>Date of Birth:</strong>{" "}
                    {formatDateOfBirth(staffDetails.dateOfBirth)}
                  </p>
                  <p>
                    <strong>Gender:</strong> {staffDetails.gender}
                  </p>
                  <p>
                    <strong>NIC:</strong> {staffDetails.nic}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    {staffDetails.maritalStatus}
                  </p>
                  <p>
                    <strong>Religion:</strong> {staffDetails.religion}
                  </p>
                </div>
              </div>
              <div className="personal-info">
                ...
                <div className="personal-details">
                  <p>
                    <strong>Educatioal Background:</strong>{" "}
                    {staffDetails.educationalBackground}
                  </p>
                  <p>
                    <strong>Certifications:</strong>{" "}
                    {staffDetails.certification}
                  </p>
                  <p>
                    <strong>Completed Courses:</strong>{" "}
                    {staffDetails.completedCourses}
                  </p>
                </div>
              </div>
              <div
