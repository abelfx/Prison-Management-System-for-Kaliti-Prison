...
const AddIncident = ({ isOpen, onClose, refreshList }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://prison-management-system-backend.onrender.com/api/incident/add",
        incidentData
      );
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <div className="add-sec-div">
                ...
                <div>
                  ...
                  />
                  {errors.reportedBy && (
                    <span className="add-incident-eroor">
                      {errors.reportedBy}
                    </span>
                  )}
                </div>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <div className="add-sec-div">
                ...
                <div>
                  ...
                  />
                  {errors.time && (
                    <span className="add-incident-eroor">{errors.time}</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="add-sec-div">
              ...
              <div>
                ...
                />
                {errors.location && (
                  <span className="add-incident-eroor">{errors.location}</span>
                )}
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div className="add-sec-div">
              ...
              <div>
                ...
                />
                {errors.action && (
                  <span className="add-incident-eroor">{errors.action}</span>
                )}
              </div>
            </div>
            <div className="add-sec-div">
