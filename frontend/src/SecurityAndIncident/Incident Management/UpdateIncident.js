...
const UpdateIncident = ({ isOpen, onClose, refreshList, incidentId }) => {
  ...
  const fetchIncidentDetails = async (id) => {
    try {
      const response = await axios.get(
        `https://prison-management-system-backend.onrender.com/api/incident/${id}`
      );
      const incident = response.data;
      const date = new Date(incident.dateOfIncident)
        .toISOString()
        .split("T")[0];
      setIncidentData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://prison-management-system-backend.onrender.com/api/incident/update/${incidentId}`,
        incidentData
      );
              ...
              <div className="w-1/2">
                <div className="form-input-div">
                  ...
                  <div>
                    ...
                    />
                    {errors.reportedBy && (
                      <span className="error-message">{errors.reportedBy}</span>
                    )}
                  </div>
                </div>
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="reportNumber"
                      value={incidentData.reportNumber}
                      onChange={handleChange}
                      className={`border ${
                        errors.reportNumber
                          ? "border-red-500"
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="date"
                      name="dateOfIncident"
                      value={incidentData.dateOfIncident}
                      onChange={handleChange}
                      className={`border ${
              ...
              <div className="w-1/2">
                <div className="form-input-div">
                  ...
                  <div>
                    <input
                      type="text"
                      name="inmateNumber"
                      value={incidentData.inmateNumber}
                      onChange={handleChange}
                      className={`border ${
                        errors.inmateNumber
                          ? "border-red-500"
                ...
                <div className="form-input-div">
                  ...
                  <div>
                    ...
                    />
                    {errors.inmateName && (
                      <span className="error-message">{errors.inmateName}</span>
                    )}
                  </div>
                </div>
