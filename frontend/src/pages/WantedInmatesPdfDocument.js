...
const WantedInmatesPDFDocument = ({ selectedInmate }) => (
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <Text style={styles.topic}>--- WANTED INMATE DETAILS REPORT ---</Text>
          ...
          >
            {selectedInmate.image && (
              <Image
                source={{
                  uri: `https://prison-management-system-backend.onrender.com/uploads/${selectedInmate.image}`,
                }}
          ...
          <Text style={styles.value}>
            ...
            {selectedInmate.releaseDate
              ? new Date(selectedInmate.releaseDate).toISOString().split("T")[0]
              : ""}
          </Text>

          <Text style={styles.label}>Estimated Sentence Duration</Text>
          <Text style={styles.value}>
            : {selectedInmate.years} years, {selectedInmate.months} months,{" "}
            {selectedInmate.days} days
          </Text>

          <Text style={styles.label}>Stayed Cell Number</Text>
          <Text style={styles.value}>: {selectedInmate.cellNumber}</Text>

          <Text style={styles.label}>Escaped Date & Time</Text>
          <Text style={styles.value}>
            :{" "}
          ...
          <Text style={styles.valuetime}> & {selectedInmate.escapedTime}</Text>

          <Text style={styles.label}>Escaped Location</Text>
          <Text style={styles.value}>: {selectedInmate.escapedLocation}</Text>
          ...
          <Text style={styles.label}>Last Clothing Description</Text>
          <Text style={styles.value}>
...
export default WantedInmatesPDFDocument;
