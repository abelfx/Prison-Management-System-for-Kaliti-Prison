...
function WantedInmates() {
  ...
  const deleteWantedInmate = async (id) => {
    const confirmed = window.confirm(
      "Are you sure you want to delete this wanted inmate?"
    );
    if (confirmed) {
      try {
        await axios.delete(
    ...
    <div className="container">
      ...
      <div>
        ...
        >
          {selectedInmate && (
            <div className="profileContainer">
              <h2 className="releasedprofileTitle">
                - WANTED INMATE DETAILS -
              </h2>
              ...
              <div className="profile-container">
                ...
                <div className="profile-item">
                  ...
                  <span className="profile-value">
                    : {selectedInmate.escapedTime}
                  </span>
                </div>
                <div className="profile-item">
                  <strong className="profile-label">Escaped Location</strong>
                  <span className="profile-value">
                    : {selectedInmate.escapedLocation}
                  </span>
                </div>
                <div className="profile-item">
                  <strong className="profile-label">
                    Physical Description (Height, Weight, Distinguishing
                    features)
                  </strong>
                  <span className="profile-value">
                    : {selectedInmate.physicalDescription}
                  </span>
                </div>
                <div className="profile-item">
                  <strong className="profile-label">
                    Clothing description at the time of escape (if known)
                  </strong>
                  <span className="profile-value">
                    : {selectedInmate.clothingDescription}
                  </span>
                </div>
                <div className="profile-item">
              ...
              <div className="bottomContainer">
                <button
                  ...
                  onClick={() => handleAddToCurrentList(selectedInmate)}
                >
                  Add To Current List
                </button>
        ...
        <Modal
          ...
          onCancel={() => {
            setIsVisibleCurrentModal(false);
          }}
          footer={null}
          closeIcon={
            <span className="closeIcon" style={{ color: "red" }}>
        ...
        >
          {selectedInmate && (
            <WantedInmatesPDFDocument selectedInmate={selectedInmate} />
          )}
        </Modal>
          ...
          {selectedInmate && (
            <UpdateWantedInmate
              ...
              updateInmate={(id, updatedData) =>
                updateWantedInmate(id, updatedData)
              }
              deleteInmate={deleteWantedInmate}
              onUpdate={(updatedData) => setSelectedInmate(updatedData)}
              setImage={(file) => console.log("Set image:", file)}
            ...
            {filteredInmates.map((inmate) => (
              <tr key={inmate._id}>
                ...
                <td>
                  <button
                    className="delete"
                    onClick={() => deleteWantedInmate(inmate._id)}
                  >
                    Delete
                  </button>
                  <button
