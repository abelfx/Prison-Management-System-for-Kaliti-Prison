  ...
  const fetchData = async () => {
    try {
      ...
      const releasedResponse = await axios.get(
        "https://prison-management-system-backend.onrender.com//getreleasedinmates"
      );
      setReleasedInmates(
    ...
    datasets: [
      {
        ...
        data: [
          countByGender(currentInmates, "Male"),
          countByGender(currentInmates, "Female"),
        ],
    ...
    <div>
      ...
      <div className="dashboard-container">
        ...
        <div className="chart-card-inmates">
          <h2 className="chart-card-inmates-title">
