  ...
  const fetchData = async () => {
    try {
      ...
      const currentAppointmentsResponse = await axios.get(
        "https://prison-management-system-backend.onrender.com/appointment/findall"
      );
      ...
      const allCurrentAppointmentsCount =
        currentAppointmentsResponse.data.length;
      ...
      const approvedAppointmentsResponse = await axios.get(
        "https://prison-management-system-backend.onrender.com/appointment/approved"
      );
      ...
      const allApprovedAppointmentsCount =
        approvedAppointmentsResponse.data.length;
      ...
      const healthRecordsResponse = await axios.get(
        "https://prison-management-system-backend.onrender.com/healthrecord/healthrecords"
      );
        ...
        <div className="allHealthcareItems">
          <div className="Dashboard-cards">
            <Link
              ...
              className="healthcareitem"
              style={{ background: "#363a87" }}
            >
          ...
          {appointmentsData && (
            <div className="pieChart">
              <h2 className="pieChartTitle" style={{ color: "#212459" }}>
                Appointments Distribution of Last 7 Days
              </h2>
              <Pie
                data={{
