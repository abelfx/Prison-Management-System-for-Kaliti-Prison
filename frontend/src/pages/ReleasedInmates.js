...
function ReleasedInmates() {
  ...
  const deleteReleasedInmate = async (id) => {
    const confirmed = window.confirm(
      "Are you sure you want to delete this released inmate?"
    );
    if (confirmed) {
      try {
        await axios.delete(
  ...
  return (
    <div className="container">
      ...
      <div>
            ...
            <div className="profileContainer">
              ...
              <div className="profile-container">
                ...
                <div className="profile-item">
                  ...
                  <span className="profile-value">
                    :{" "}
                    {selectedInmate.realReleaseDate
                      ? new Date(selectedInmate.realReleaseDate)
                          .toISOString()
                          .split("T")[0]
                      : ""}
                  </span>
                ...
                <div className="profile-item">
                  ...
                  <span className="profile-value">
                    : {selectedInmate.releaseReason}
                  </span>
                </div>
                <div className="profile-item">
                  <strong className="profile-label">
                    Release By (Officer Name)
                  </strong>
                  <span className="profile-value">
                    : {selectedInmate.releaseBy}
                  </span>
                </div>
                <div className="profile-item">
                  <strong className="profile-label">
                  ...
                  <span className="profile-value">
                    : {selectedInmate.confirmReleased}
                  </span>
                </div>
                <div className="profile-item">
              ...
              <div className="bottomContainer">
                <button
                  className="downloadReleasedProfile"
        ...
        >
          {selectedInmate && (
            <ReleasedInmatesPDFDocument selectedInmate={selectedInmate} />
          )}
        </Modal>
            ...
            {filteredInmates.map((inmate) => (
              <tr key={inmate._id}>
                ...
                <td>
                  <button
                    className="delete"
                    onClick={() => deleteReleasedInmate(inmate._id)}
                  >
                    Delete
                  </button>
                </td>
