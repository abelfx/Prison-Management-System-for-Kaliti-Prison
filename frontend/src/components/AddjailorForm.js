...
function AddjailorForm() {
  ...
  const PageDisplay = () => {
    if (page === 0) {
      return (
        <JailorPersonalInfo formData={formData} setFormData={setFormData} />
      );
    } else if (page === 1) {
      return (
        <JailorEmploymentInfo formData={formData} setFormData={setFormData} />
      );
    } else {
      return (
        <JailorHealthandEqumentInfo
          formData={formData}
    ...
    <div className="form-Jailor" style={{ marginLeft: -65, marginTop: -40 }}>
      <div className="form-container" style={{ border: "none" }}>
        <div className="header">
          ...
          <h2 style={{ color: "#000000", marginLeft: 50, width: 500 }}>
            {FormTitles[page]}
          </h2>
        </div>
        ...
        <div className="addjailor-footer">
          ...
          {page !== FormTitles.length - 1 && (
            <button
              onClick={() => setPage((currPage) => currPage + 1)}
              className="Addjailor-button-next"
          ...
          {page === FormTitles.length - 1 && (
            <button
              ...
              className="Addjailor-button-submit"
              style={{ marginLeft: 500 }}
            >
              Submit
            </button>
