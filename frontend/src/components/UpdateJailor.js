  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <label className="update-jailor-label">
        ...
        <input
          ...
          value={inputs.EmergencyContactNumber}
          onChange={handleChange}
        />
        <br />
        ...
        >
          ...
          <option value="CorrectionalLieutenant">
            Correctional Lieutenant
          </option>
          <option value="CorrectionalCaptain">Correctional Captain</option>
          <option value="CorrectionalAdministrator">
            Correctional Administrator
          </option>
          <option value="CorrectionalSupervisor">
        ...
        >
          ...
          <option value="Eblock">
            E Block (Space Planning and Utilization Department)
          </option>
          <option value="Fblock">
            F Block (Sanitation and Hygiene Department)
          </option>
          <option value="Gblock">
            G Block (Maintenance and Repairs Department)
          </option>
        ...
        <textarea
          ...
          className="update-jailor-input"
          onChange={handleChange}
          value={inputs.EducationalBackground}
        ></textarea>
        <br />
        <label className="update-jailor-label">
          Relevant Certifications (e.g. Correctional Officer Certification) :{" "}
        </label>
        <textarea
          ...
          className="update-jailor-input"
          onChange={handleChange}
          value={inputs.RelevantCertifications}
        ></textarea>
        <br />
        <label className="Addjailor-lable">
          Training Courses Completed (e.g. First Aid,Crisis Management) :{" "}
        </label>
        <textarea
          name="TrainingCoursesCompleted"
          rows="4"
          cols="50"
          className="update-jailor-input"
          onChange={handleChange}
          value={inputs.TrainingCoursesCompleted}
        ></textarea>
        <br />
        ...
        <label className="update-jailor-label">
          Issued Equipment (e.g. handcuffs, radio):
        </label>
        <input
          type="text"
        ...
        <textarea
          name="EquipmentTrainingStatus"
          rows="4"
          cols="50"
          className="update-jailor-input"
          onChange={handleChange}
          value={inputs.EquipmentTrainingStatus}
        ></textarea>
        <br />
        ...
        <textarea
          ...
          className="update-jailor-input"
          onChange={handleChange}
          value={inputs.EmergencyMedicalInformation}
        ></textarea>
        <br />
        <button type="submit" className="update-jailor-submit-button">
          Submit
        </button>
      </form>
    </div>
