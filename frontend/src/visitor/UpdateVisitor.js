...
const UpdateVisitor = ({ isOpen, onClose, refreshList, visitorId }) => {
  ...
  const fetchVisitorDetails = async (visitorId) => {
    try {
      const response = await axios.get(
        `https://prison-management-system-backend.onrender.com/api/visitor/${visitorId}`
      );
      ...
      const formattedDateOfBirth = new Date(dateOfBirth)
        ...
        .split("T")[0];
      // Format dateOfVisit
      const formattedDateOfVisit = new Date(dateOfVisit)
        .toISOString()
        .split("T")[0];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://prison-management-system-backend.onrender.com/api/visitor/update/${visitorId}`,
        visitorData
      );
  ...
  return (
    <div
      className={`v-add-incident-overlay ${isOpen ? "v-inci" : "v-inci-hide"}`}
    >
      <div className="v-add-incident-container">
        <FaWindowClose
          ...
          color="red"
          onClick={onClose}
          className="v-add-incident-close"
        />
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            <div>
              <div className="" style={{ padding: "2px" }}>
                ...
                />
                {errors.firstName && (
                  <span className="v-add-incident-eroor">
                    {errors.firstName}
                  </span>
                )}
              </div>
              ...
              <div className="" style={{ padding: "5px" }}>
                ...
                {errors.gender && (
                  <span className="v-add-incident-eroor">{errors.gender}</span>
                )}
              </div>
              <div className="" style={{ padding: "5px" }}>
                ...
                />
                {errors.nic && (
                  <span className="v-add-incident-eroor">{errors.nic}</span>
                )}
              </div>
              <div className="" style={{ padding: "5px" }}>
                ...
                />
                {errors.address && (
                  <span className="v-add-incident-eroor">{errors.address}</span>
                )}
              </div>
              <div className="" style={{ padding: "5px" }}>
                ...
                />
                {errors.email && (
                  <span className="v-add-incident-eroor">{errors.email}</span>
                )}
              </div>
              <div className="" style={{ padding: "5px" }}>
            ...
            <div>
              <div className="" style={{ padding: "5px" }}>
                ...
                <input
                  type="text"
                  name="inmateNo"
                  value={visitorData.inmateNo}
                  onChange={handleChange}
                  className={`v-form-input ${
                    errors.inmateNo ? "border-red-500" : "border-gray-300"
                  } rounded-md`}
                />
                {errors.inmateNo && (
                  <span className="v-add-incident-eroor">
              ...
              <div className="" style={{ padding: "5px" }}>
                ...
                <input
                  type="text"
                  name="inmateName"
                  value={visitorData.inmateName}
                  onChange={handleChange}
                  className={`v-form-input ${
                    errors.inmateName ? "border-red-500" : "border-gray-300"
                  } rounded-md`}
                />
                {errors.inmateName && (
                  <span className="v-add-incident-eroor">
              ...
              <div className="" style={{ padding: "5px" }}>
                ...
                <input
                  type="time"
                  name="timeOfVisit"
                  value={visitorData.timeOfVisit}
                  onChange={handleChange}
                  className={`v-form-input ${
                    errors.timeOfVisit ? "border-red-500" : "border-gray-300"
                  } rounded-md`}
                />
                {errors.timeOfVisit && (
                  <span className="v-add-incident-eroor">
          ...
          <div className="flex justify-end" style={{ marginTop: "20px" }}>
            <button
              type="submit"
              className="v-add-incident-button"
